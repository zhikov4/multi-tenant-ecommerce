...
class DatabaseConfig
{
    ...
    public function connection(): array
    {
        ...
        $templateConnection = config("database.connections.{$template}")
            ?? config('database.connections.' . config('tenancy.database.central_connection'));
    ...
    {
        $templateConnection = $this->getTemplateConnectionName();

        $driver = config("database.connections.{$templateConnection}.driver")
            ?? config('database.connections.' . config('tenancy.database.central_connection') . '.driver');
